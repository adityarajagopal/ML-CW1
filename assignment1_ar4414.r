...
main <- function(){
	...
	#generate_plot(error,epsilon,sample_size,gamma);
	...
	for (g in gamma){
		...
		print(q3b43$T);
		print(q3b43$w_star);
		write(t(q3b43$i),file='q3b_graphs/q3b.txt');
		write(t(q3b43$T),file='q3b_graphs/q3b.txt');
		write(t(q3b43$w_star),file='q3b_graphs/q3b.txt');
	}
}
